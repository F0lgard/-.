    ...
    <main class="main">
        <div class="case-poslygu">
            ...
            <ul class="name-case-p">
                <li class="scobap">[</li>
                <li class="name-pos">CROSSFIT</li>
                <li class="scobap">]</li>
            </ul>

        <span class="text-c">
        CrossFit - це інтенсивна форма тренування, що поєднує різноманітні фізичні вправи, такі як силові тренування, аеробні вправи, гімнастика та інші функціональні рухи. Ця форма тренування спрямована на покращення загальної фізичної підготовленості, збільшення сили, витривалості, гнучкості та швидкості. Однією з основних переваг CrossFit є його різноманітність і висока інтенсивність, що дозволяє досягати швидких результатів і покращувати загальну фітнес-кондицію. Однак, необхідно пам'ятати про ризики травм, які можуть виникнути внаслідок неправильної техніки виконання вправ або надмірного навантаження.         </span>
        <img src="img/alonso-reyes-0HlI76m4jxU-unsplash.jpg" class="img-c" alt="cycle">
