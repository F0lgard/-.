    ...
    <main class="main">
        <div class="case-poslygu">
            ...
            <ul class="name-case-p">
                <li class="scobap">[</li>
                <li class="name-pos">FITNESS</li>
                <li class="scobap">]</li>
            </ul>

        <span class="text-c">
        
Фітнес - це тренування для поліпшення фізичної форми. Він має багато плюсів: зміцнює серцево-судинну та дихальну системи, розвиває м'язи, покращує настрій та контролює вагу. Але можуть бути й мінуси, такі як ризик травм, витрати часу і грошей, втрата мотивації.
<br><br>Фітнес розрахований на широку аудиторію всіх вікових груп і рівнів підготовки. Незалежно від вашого віку чи фізичної форми, існують різноманітні види фітнесу, що дозволяють знайти оптимальну форму тренування. Займаючись фітнесом, ви можете зустріти нових людей, побудувати соціальні зв'язки та знайти мотивацію для досягнення своїх фітнес-цілей.

        </span>
        <img src="img/bruce-mars-HHXdPG_eTIQ-unsplash.jpg" class="img-c" alt="cycle">
