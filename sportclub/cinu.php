...
<head>
    ...
    <link rel="stylesheet" href="css/cinu.css">
    <title>Ціни</title>
</head>
<body>
<?php 
...
<div class="page">
    ...
    <main class="main">
        <div class="case-abon">
            ...
            <ul class="name-case-a">
                <li class="scobaabon">[</li>
                <li class="name-abon">АБОНЕМЕНТИ</li>
                <li class="scobaabon">]</li>
            </ul>
            <div class="gym">
                <div class="stroke-gym"></div>
                ...
                <div class="horizontal-lines">
                  ...
                  <ul class="custom-list">
                    <li>12000 грн. при сплаті на 10 міс</li>
                    <li>1700 грн/міс (контракт на 10 міс)</li>
                    <li>2000 грн/міс (повна вартість)</li>
                    <li>Відвідування тренажерного залу</li>
                    <li>Відвідування кардіо зони</li>
                    <li>Відвідування кросфіт зони</li>
                    <li>Сауна</li>
                  </ul>
                  <a href="pp.html"><button tupe="button" class="prudbatu">Придбати</button></a>
            </div>

            <div class="premium">
                <div class="stroke-prem"></div>
                <img src="img/premium.png" class="img-prem">
                <div class="horizontal-lines-prem">
                    <hr>
                    <hr>
                    <hr>
                    <hr>
                  ...
                  <ul class="custom-list-prem">
                    <li>2500 грн/міс (Контракт на 10 міс)</li>
                    <li>3000 грн. (повна вартість)</li>
                    <li>Відвідування тренажерного залу</li>
                    <li>Відвідування кардіо зони</li>
                    <li>Відвідування кросфіт зони</li>
                    <li>Консультації тренера</li>
                    <li>Групові програми (розклад) (12/міс)</li>
                    <li>Сауна</li>
                  </ul>
                  <a href="pp.html"><button tupe="button" class="prudbatu-prem">Придбати</button></a> 
            </div>

            <div class="vio">
                <div class="stroke-vip"></div>
                <img src="img/vip.png" class="img-vip">
                <div class="horizontal-lines-vip">
                    <hr>
                    <hr>
                    <hr>
                    <hr>
                  ...
                  <ul class="custom-list-vip">
                    <li>32 000 грн. при оплаті на 10 міс.</li>
                    <li>Відвідування тренажерного залу</li>
                    <li>Відвідування кардіо зони</li>
                    <li>Відвідування кросфіт зони</li>
                    <li>Консультації тренера</li>
                    <li>Групові програми (розклад) (12/міс)</li>
                    <li>Гостьові візити (5 візитів)</li>
                    <li>Персон. тренування (10 тренувань)</li>
                    <li>Сауна</li>
                  </ul>
                  <a href="pp.html"><button tupe="button" class="prudbatu-vip">Придбати</button></a> 
            </div>
        </div>
