    ...
    <main class="main">
        <div class="case-poslygu">
            ...
            <ul class="name-case-p">
                <li class="scobap">[</li>
                <li class="name-pos">ПОСЛУГИ</li>
                <li class="scobap">]</li>
            </ul>
        <img src="img/cycle.png" class="img-cucle">
        <a href="poslygu-c.php"><button type="button" class="cycle-b">CYCLE</button></a>

        <img src="img/fitness.png" class="img-fit">
        <a href="poslygu-fit.php"><button type="button" class="fit-b">FITNESS</button></a>

        <img src="img/functional.png" class="img-fun">
        <a href="poslygu-fun.php"><button type="button" class="fun-b">FUNCTIONAL</button></a>

        <img src="img/weight.png" class="img-wei">
        <a href="poslygu-w.php"><button type="button" class="wei-b">WEIGHTLIFTING</button></a>

        <img src="img/crossfit.png" class="img-cros">
        <a href="poslygu-cros.php"><button type="button" class="cros-b">CROSSFIT</button></a>

        <img src="img/rehab.png" class="img-reh">
        <a href="poslygu-reh.php"><button type="button" class="reh-b">REHABILITATION</button></a>
