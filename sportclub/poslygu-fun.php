    ...
    <main class="main">
        <div class="case-poslygu">
            ...
            <ul class="name-case-p">
                <li class="scobap">[</li>
                <li class="name-pos">FUNCTIONAL</li>
                <li class="scobap">]</li>
            </ul>

        <span class="text-c">
        
        Functional тренування - це методика фізичних вправ, спрямована на розвиток функціональної сили, гнучкості, стійкості та координації рухів. Це динамічна форма тренування, яка активно використовується як у спортивних командах, так і в тренажерних залах. Під час функціонального тренування використовуються різні види обтяжень, такі як власна вага, гантелі, гірки, м'ячі та інші пристрої. Ця методика дозволяє працювати над різними групами м'язів одночасно, зміцнюючи тіло в комплексі.
        </span>
        <img src="img/mr-lee-f4RBYsY2hxA-unsplash.jpg" class="img-c" alt="cycle">
