...
<div class="page">
    ...
    <main class="main">
        <div class="case-news">
            <div class="fon-news"></div>
            <ul class="name-case-n">
                <li class="scoban">[</li>
                <li class="name-news">НОВИНИ</li>
                <li class="scoban">]</li>
            </ul>

            <div class="news1">
                <div class="news1-fon"></div>
                <img src="img/news1.png" class="img-news1">
                <span class="text-news1">Звітуємо про підвищення тренажерної бази нашого спортклубу. Оглянувши потреби клієнтів, ми додали більше обладнання, щоб забезпечити кращі умови для тренувань.</span>
                <span class="date-news1">08.05.2023</span>
            </div>

            <div class="news2">
                <div class="news2-fon"></div>
                <img src="img/news2.png" class="img-news2">
                <span class="text-news2">Тренування зі знаменитостями. Клуб організовує тренування з відомими спортсменами та знаменитостями, які діляться своїм досвідом та підтримують клієнтів.</span>
                <span class="date-news2">05.05.2023</span>
            </div>

            <div class="news3">
                <div class="news3-fon"></div>
                <img src="img/news3.png" class="img-news3">
                <span class="text-news3">Запуск фітнес-челенджу. Клуб запускає фітнес-челендж для своїх клієнтів, який допоможе досягти максимальних результатів за короткий проміжок часу.</span>
                <span class="date-news3">01.05.2023</span>
            </div>
        </div>
