...
<head>
    ...
    <link rel="stylesheet" href="css/reh.css">
    ...
    <main class="main">
        <div class="case-poslygu">
            ...
            <ul class="name-case-p">
                <li class="scobap">[</li>
                <li class="name-pos">REHABILITATION</li>
                <li class="scobap">]</li>
            </ul>

        <span class="text-c">
        Реабілітація в спорт-клубі є корисною процедурою, оскільки вона сприяє відновленню травмованих спортсменів і покращенню їх фізичного стану. Це включає в себе спеціалізовані вправи, фізіотерапію та інші методи, спрямовані на зняття болю, поліпшення рухової функції, м'язової сили та гнучкості. Реабілітаційні програми також допомагають спортсменам повернутися до спортивної діяльності після травми, зменшуючи ризик подальших ушкоджень і покращуючи їх загальну фізичну підготовку. </span>
        <img src="img/sincerely-media-ohMu8-iQfmY-unsplash.jpg" class="img-c" alt="cycle">
</div>
